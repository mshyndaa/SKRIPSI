...
.hibob {
                    ...
                    <table class="table table-bordered table-dark small">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th scope="col">Total Device Yang Mati</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
    ...
    <script>
        ...
        console.log("sana");
            $.ajax({
                ...
                success: function (data) {
                   ...
                   //document.getElementById("wifirect").innerHTML = '<text id="wificount1" x="20%" y="55%" font-family="Arial" font-size="55px" fill="' + colortext + '" font-weight="bold"></text>\n\
                    ...
                    document.getElementById("wifirect").innerHTML = '<text id="wificount1" x="20%" y="40%" font-family="Arial" font-size="55px" fill="' + colortext + '" font-weight="bold"></text>\n\
                                                                     <text x="30%" y="50%" font-family="Arial" font-size="12px" fill="' + colortext + '">' + response[0]['Name'] + '</text>\n\
                                                                         <text x="30%" y="60%" font-family="Arial" font-size="12px" fill="' + colortext + '">' + (response[0]['Ip']==null?'':response[0]['Ip']) + '</text>\n\
                                                                       <rect x="55%" y="74%" width="2px" height="22%" fill="purple"></rect>\n\
                                                            <text x="10%" y="80%" font-family="Arial" font-size="12px" fill="' + colortext + '">' + response[0]['WifiDownload']  + '</text>\n\\n\
                                                            <text x="65%" y="80%" font-family="Arial" font-size="12px" fill="' + colortext + '">' + response[0]['WifiUpload']  + '</text>\n\
                                                              <text x="7%" y="90%" font-family="Arial" font-size="12px" fill="' + colortext + '" font-height="bold">Mbps Download</text>\n\
                                                                  <text x="62%" y="90%" font-family="Arial" font-size="12px" fill="' + colortext + '" font-height="bold">Mbps Upload</text>';
            ...
            console.log($("#dropDownDevice").val());
